...
correlation inside that one municipality and a pooled value would repeat it; the
parenthesis is the s.d. over seeds (the unadapted model has one). Brazil: 48
