...
and oracle by municipality, the city-clustered bootstrap puts the test fraction of the base backbone at $0.85$ with a wide interval [$0.29$, $1.83$]; fourteen cities bound the precision,
...
+0.29$] for the base backbone and $+0.22$ [$+0.10$, $+0.29$] for the large backbone; on the test cities
...
and $+0.19$ [$+0.05$, $+0.29$] on test with the base backbone, $+0.29$ [$+0.02$, $+0.46$] and
$+0.22$ [$+0.07$, $+0.37$] with the large backbone, the only one of the four that separates on
test. Against GHSL built-up surface ($+0.15$ [$-0.10$, $+0.30$]; $+0.06$ [$-0.10$,
$+0.16$] with the base backbone) and GHSL building height ($+0.13$ [$-0.10$, $+0.29$]; $+0.11$
...
[$-0.25$, $+0.10$] on test with the base backbone, $+0.04$ [$-0.09$, $+0.13$] and $+0.00$
[$-0.18$, $+0.13$] with the large backbone. A 1 km light product, free and requiring no model,
...
pooled detection of high and very-high grade tracts across the split (map with the base backbone
0.828 on validation and 0.829 on test, with the large backbone 0.818 and 0.827). Orientation was
