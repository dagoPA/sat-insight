...
radar vectors ($0.084$ and $0.016$). Copernicus-FM base sits at the base backbone under
cross-validation. Offering the four GHSL and nighttime-light columns to the head as
...
where it was run. Dimensions are per token. Copernicus-FM's test column is filled by the
same validation-selected protocol as the other backbones.}
\small
\begin{tabular}{llccc}
\toprule
...
Copernicus-FM base, optical and radar fused & 1536 & 0.212 & -- & 0.197 [0.170, 0.225]\\
