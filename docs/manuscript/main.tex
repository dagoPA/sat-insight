...
ground truth for the same city is shown in Fig.~\ref{fig:truth}; Tapachula sits at the
...
\caption{Tract-level ground truth for Tapachula, on the color scale of
Fig.~\ref{fig:design}c. Every token inherits the held-out GRS grade of the AGEB it
falls in.}
\label{fig:truth}
\end{figure}
