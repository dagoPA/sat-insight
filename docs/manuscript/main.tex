...
the maps reach a within-municipality $\rho$ of $0.23$ [$0.08$, $0.36$] with the base
feature extractor and $0.27$ [$0.15$, $0.37$] with DOFA-L; GHSL residential population
...
\midrule
Map & none (reference) & 0.242 / 0.224 / 0.215 & 0.227 & \\
...
153 bags, the head orders Bogot\'a's block strata at $\rho = 0.25$ with the base
feature extractor (seeds $0.23$, $0.28$, $0.24$; AUROC 0.66 for the most deprived quartile) and
$0.17$ with DOFA-L ($0.21$, $0.16$, $0.14$), against $0.31$ and $0.52$ for the
...
municipalities at $\rho = 0.12$ [$0.08$, $0.17$] over 47 municipalities with the base
feature extractor ($0.12$, $0.13$, $0.13$; pooled $0.34$; AUROC 0.64) and $0.16$ [$0.10$, $0.21$]
...
for both feature extractors on the same bags. Within-municipality Spearman against the fine truth,
grouped five-fold by municipality, per seed; Bogot\'a's oracle folds over 3.2 km spatial
cells. Colombia: 153 bags, 89{,}064 built tokens, the Bogot\'a block strata as truth
over 12{,}738 of them, so the within and pooled values coincide and no interval is
formed. Brazil: 48 bags, 121{,}647 built tokens, tract median income of the household
head as truth over 110{,}728 tokens in 47 municipalities, with the municipality-bootstrap
interval of the mean. AUROC is for the most deprived quartile of the truth, pooled. The
...
\toprule
Country & Features & Method & Seeds & Mean [95\%] & Pooled $\rho$ & AUROC\\
\midrule
Colombia & DOFA-B & Mexican, unadapted & 0.311 & 0.311 & 0.311 & 0.705\\
Colombia & DOFA-B & local aggregates, 50 bags & 0.388 / 0.257 / 0.343 & 0.329 & 0.329 & 0.701\\
Colombia & DOFA-B & local aggregates, 100 bags & 0.277 / 0.202 / 0.246 & 0.242 & 0.242 & 0.655\\
Colombia & DOFA-B & local aggregates, 153 bags & 0.233 / 0.284 / 0.244 & 0.254 & 0.254 & 0.657\\
Colombia & DOFA-B & Mexican, fine-tuned & 0.367 / 0.306 / 0.271 & 0.315 & 0.315 & 0.696\\
Colombia & DOFA-B & oracle & 0.737 / 0.757 / 0.745 & 0.747 & 0.747 & 0.903\\
Colombia & DOFA-L & Mexican, unadapted & 0.520 & 0.520 & 0.520 & 0.806\\
Colombia & DOFA-L & local aggregates, 50 bags & 0.202 / 0.210 / 0.139 & 0.183 & 0.183 & 0.610\\
Colombia & DOFA-L & local aggregates, 100 bags & 0.235 / 0.144 / 0.187 & 0.189 & 0.189 & 0.615\\
Colombia & DOFA-L & local aggregates, 153 bags & 0.209 / 0.160 / 0.136 & 0.168 & 0.168 & 0.602\\
Colombia & DOFA-L & Mexican, fine-tuned & 0.432 / 0.415 / 0.395 & 0.414 & 0.414 & 0.748\\
Colombia & DOFA-L & oracle & 0.789 / 0.791 / 0.798 & 0.793 & 0.793 & 0.918\\
\midrule
Brazil & DOFA-B & Mexican, unadapted & 0.099 & 0.099 [0.048, 0.148] & 0.283 & 0.648\\
Brazil & DOFA-B & local aggregates, 48 bags & 0.118 / 0.125 / 0.126 & 0.123 [0.075, 0.171] & 0.340 & 0.640\\
Brazil & DOFA-B & Mexican, fine-tuned & 0.073 / 0.077 / 0.085 & 0.078 [0.026, 0.129] & 0.337 & 0.633\\
Brazil & DOFA-B & oracle & 0.250 / 0.243 / 0.232 & 0.242 [0.193, 0.290] & 0.464 & 0.704\\
Brazil & DOFA-L & Mexican, unadapted & 0.171 & 0.171 [0.120, 0.223] & 0.411 & 0.689\\
Brazil & DOFA-L & local aggregates, 48 bags & 0.150 / 0.159 / 0.157 & 0.155 [0.103, 0.210] & 0.452 & 0.694\\
Brazil & DOFA-L & Mexican, fine-tuned & 0.177 / 0.190 / 0.190 & 0.185 [0.136, 0.236] & 0.460 & 0.689\\
Brazil & DOFA-L & oracle & 0.283 / 0.277 / 0.294 & 0.285 [0.230, 0.337] & 0.539 & 0.736\\
\bottomrule
\end{tabular}}
\label{tab:transfer}
\end{table}
