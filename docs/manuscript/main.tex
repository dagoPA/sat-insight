...
cities the map reaches a within-municipality rank correlation of $\rho = 0.20$ with a
DOFA base backbone and $0.23$ with DOFA large, 84\% and 77\% of what the same features
...
\item Test maps reach 84\% (DOFA base) and 77\% (DOFA large) of the fully supervised bound
...
appended to the 1{,}536 dimensions of the DOFA base encoder; this ablation was run on
DOFA base only. Two fusions are compared on the full pool,
three seeds each, against the DOFA base head without extras: early, the columns enter the projection
...
cities: the fused DOFA large vectors ($0.226$), the fused DOFA base vectors ($0.196$),
the thirteen land-cover columns of WorldCover fractions and NDVI with no learned
representation ($0.219$, indistinguishable from DOFA base on test and far below it on
...
radar vectors ($0.084$ and $0.016$). Copernicus-FM base sits at DOFA base under
...
\midrule
DOFA large, optical and radar fused & 2048 & 0.242 & 0.226 & 0.230 [0.203, 0.257]\\
DOFA large, optical 10 m & 1024 & 0.235 & 0.207 & \\
DOFA large, optical degraded to 20 m & 1024 & 0.217 & 0.191 & \\
DOFA large, radar & 1024 & 0.022 & 0.016 & \\
DOFA base, optical and radar fused & 1536 & 0.227 & 0.196 & 0.203 [0.170, 0.234]\\
DOFA base, optical 10 m & 768 & 0.183 & 0.179 & \\
DOFA base, optical degraded to 20 m & 768 & 0.171 & 0.129 & \\
DOFA base, radar & 768 & 0.006 & 0.084 & \\
...
DOFA base fused plus GHSL and lights, early fusion & 1540 & 0.225 & -- & \\
\bottomrule
\end{tabular}
\label{tab:features}
\end{table}
...
folds of the national set), filled DOFA base and hollow DOFA large, the only criterion
...
within-municipality map quality on DOFA base and $+0.25$ on DOFA large, and $+0.62$ and
