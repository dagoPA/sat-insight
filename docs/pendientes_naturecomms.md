...
- [ ] **B1. Incertidumbre honesta en la curva.** Bootstrap agrupado por ciudad sobre las
...
- [ ] **B4. Los 9 municipios fallidos de la expansión.** Documentar cuáles y por qué;
      si Lagos de Moreno y los del norte no tienen profundidad óptica suficiente, quedan
      excluidos con criterio explícito, no en silencio.
...
- [ ] **C6. Code availability.** El repo ya cumple (uv.lock, tests); falta licencia,
