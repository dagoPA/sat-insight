...
from granularity_curve import relabel  # noqa: E402
from supervision_curve import grades_of, links_of, nested_sample, train_once  # noqa: E402
...
def main() -> None:
    ...
    from a5_aggregation import population_weights, train_weighted
