...
are scored with the winner already chosen.
"""
...
def main() -> None:
    ...
    # the stopping criterion is the bag error, the only signal weak supervision is
    # entitled to look at: choosing the epoch by map quality would use the AGEB label the
    # project claims not to use
