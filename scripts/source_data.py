...
def main() -> None:
    ...
    for name, src in (
        ...
        ("supp_table8_zeroshot.csv", "data/transfer_zeroshot.csv"),
        ("fig5c_conformal_coverage_by_city.csv", "data/uncertainty_coverage_city.csv"),
        ("supp_table2_maup.csv", "data/maup.csv"),
        ("supp_table4_incumbents_val.csv", "data/global_products.csv"),
        ("supp_table4_incumbents_test.csv", "data/global_products_test.csv"),
        ("supp_table5_conformal.csv", "data/uncertainty_conformal.csv"),
        ("supp_table6_city_audit.csv", "data/city_audit_test.csv"),
