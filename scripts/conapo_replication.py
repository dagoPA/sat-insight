...
"""How the IMU workbook spells its two highest marginalization grades; values of the source file."""
...
def main() -> None:
    ...
    imu = pd.ExcelFile("data/external/IMU_2020.xls").parse("IMU_2020")
    ...
    high = joined.GM_2020.isin(CONAPO_HIGH_GRADES).astype(int)
