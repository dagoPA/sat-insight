...
Usage: incumbentes_globales.py [data/predicciones_val.parquet]
"""
...
def main() -> None:
    ...
    products = values_per_ageb(cities, catalogue, Path(f"data/incumbentes_agebs{suffix}.parquet"))
    ...
    output = Path(f"data/incumbentes_globales{suffix}.csv")
